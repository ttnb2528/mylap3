...
function handleSearch(e) {
    if (inputSearch.value.length <= 0) {
        ...
        window.location.href = "../tìm kiếm/index.html";
    }
...
function frmValidate() {
    ...
    var email_user = document.getElementById('input-email').value;
    var password_user = document.getElementById('input-psw').value;

    var user = JSON.parse(localStorage.getItem('dangky'));

    if(email_user == user.email && password_user == user.password){
